...
const Footer: React.FC = () => {
  return (
    <footer className='px-4 py-10 bg-black text-yellow-300 flex w-full'>
      <div className='max-w-[1400px] mx-auto space-y-10 lg:space-y-16 w-full'>
        <div className='space-y-16 lg:flex lg:justify-between w-full lg:space-y-0 lg:space-x-16'>
          <div className='flex flex-col space-y-8 lg:space-y-5 lg:max-w-xs'>
            ...
            <div className='flex space-x-5 text-yellow-400 items-center'>
              <a
              ...
              >
                <div className='lg:hover:scale-110 duration-150'>
                  ...
                  >
                    ...
                    />
                    <path
                      d='M6.30928 5.34607C6.30928 5.81335 5.90426 6.19215 5.40464 6.19215C4.90502 6.19215 4.5 5.81335 4.5 5.34607C4.5 4.87880 4.90502 4.5 5.40464 4.5C5.90426 4.5 6.30928 4.87880 6.30928 5.34607Z'
                      fill='white'
                    />
                    <path
            ...
            <div className='lg:space-y-2 lg:justify-self-end group'>
              ...
              <div>
                <div className='space-x-2 py-1 flex items-center'>
                  <div className='text-white hover:text-yellow-300 duration-300 cursor-progress'>
                    Bootcamp
                  </div>
                  <div>
                    <div className='border flex items-center justify-center w-fit text-nowrap rounded-full bg-yellow-600 text-black border-yellow-500 py-0.5 px-1.5 animate-pulse text-xs'>
                      <p>soon</p>
                    </div>
                  </div>
                </div>
        ...
        <hr className='border-none h-[1px] bg-yellow-500/20' />
